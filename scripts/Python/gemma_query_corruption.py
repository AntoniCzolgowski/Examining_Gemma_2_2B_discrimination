...
# Assign all generated combinations for processing 
...
def create_prompt(combo):
    ...
    prompt = (
        ...
        "Taking into account all these factors, please rate on a scale from 1 (there is no corruption in my country) to 10 (there is abundant corruption in my country) How would you place your views on corruption in your country? Corruption happens  when people pay a bribe, give a gift or do a favor to other people in order to get the things they need done or the services they need. <|im_end|>\n"
...
output_filename = "korupcja-model-1.csv"
