...
def create_prompt(combo):
    ...
    prompt = (
        ...
        "Taking into account all these factors, please rate on a scale from 1 (completely disagree) to 10 (completely agree) to what extent you believe science and technology are making our lives healthier, easier and more comfortable<|im_end|>\n"
...
output_filename = "technologia-model-1.csv"
