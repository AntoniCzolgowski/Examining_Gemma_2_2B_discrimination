...
def create_prompt(combo):
    ...
    prompt = (
        ...
        "Taking into account all these factors and all things considered, please rate on a scale from 1 (Completely dissatisfied) to 10 (Completely satisfied) how satisfied are you with your life as a whole? <|im_end|>\n"
...
output_filename = "satysfakcja-model-1.csv"
