...
def create_prompt(combo):
    ...
    prompt = (
        ...
        "Taking into account all these factors, please rate on a scale from 1 (not at all important) to 10 (absolutely important) how important is it for you to live in a country that is governed democratically? <|im_end|>\n"
...
output_filename = "demokracja-model-1.csv"
